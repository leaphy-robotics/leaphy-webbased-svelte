...
export default class LeaphyToolbox extends Blockly.Toolbox {
	...
	props = $state<{
		toolboxDef: Blockly.utils.toolbox.ToolboxItemInfo[], workspace: Blockly.Workspace, selected: string
	...
	selectItem_(oldItem: ISelectableToolboxItem, newItem: ISelectableToolboxItem) {
