...
import actuators from "./arduino/actuators";
...
import operators from "./arduino/operators";
import * as procedures from "./arduino/procedures";
import * as rtc from "./arduino/rtc";
import sensors from "./arduino/sensors";
import situation from "./arduino/situation";
