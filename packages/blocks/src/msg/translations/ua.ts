...
messages.TEACHABLE_AUDIO_CLASSIFY = "прослухати та класифікувати звук";
messages.TEACHABLE_AUDIO_DETECTED = "звук %1 виявлено";
messages.TEACHABLE_AUDIO_CONFIDENCE = "впевненість для %1";
messages.TEACHABLE_AUDIO_CATEGORY = "Teachable Machine";
messages.TEACHABLE_AUDIO_OPEN = "Відкрити Teachable Machine";
...
messages.LEAPHY_SPARK_RGB =
	"Leaphy Spark світлодіод: червоний %1 зелений %2 синій %3";
...
messages.LEAPHY_SPARK_LEFT_AMBIENT_LIGHT_SENSOR =
	"лівий датчик зовнішнього освітлення";
messages.LEAPHY_SPARK_RIGHT_AMBIENT_LIGHT_SENSOR =
	"правий датчик зовнішнього освітлення";
