...
messages.CONFIRM_CLEAR =
	"Dit wist je huidige datasets, weet je zeker dat je door wilt gaan?";
...
messages.LEAPHY_MESH_CREATE_SIGNAL = "Maak signaal aan";
messages.LEAPHY_MESH_NEW_SIGNAL = "Geef je signaal een naam";
messages.LEAPHY_MESH_ON_SIGNAL = "Wanneer ik %1 ontvang";
messages.LEAPHY_MESH_BROADCAST_SIGNAL = "Zend signaal %1";
messages.LEAPHY_MESH_CALL_SIGNAL = "Verstuur signaal %1 naar %2";
messages.LEAPHY_MESH_SENDER = "afzender";
...
messages.TEACHABLE_AUDIO_CLASSIFY = "luister en classificeer geluid";
messages.TEACHABLE_AUDIO_DETECTED = "%1 geluid gedetecteerd";
messages.TEACHABLE_AUDIO_CONFIDENCE = "zekerheid voor %1";
messages.TEACHABLE_AUDIO_CATEGORY = "Teachable Machine";
messages.TEACHABLE_AUDIO_OPEN = "Teachable Machine openen";
