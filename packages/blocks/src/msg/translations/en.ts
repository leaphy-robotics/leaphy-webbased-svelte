...
messages.LEAPHY_DISPLAY_LARGE_CLEAR = "Clear large display";
...
messages.LEAPHY_DHT22_READ_TEMPERATURE = "Read temperature from DHT22 on pin";
messages.LEAPHY_DHT22_READ_HUMIDITY = "Read humidity from DHT22 on pin";
...
messages.LEAPHY_LED_STRIP_COLORGULF = "Color Wave";
messages.LEAPHY_LED_STRIP_DEMO = "Ledstrip demo";
messages.LEAPHY_LED_STRIP_GULF = "Wave";
...
messages.CONFIRM_CLEAR =
	"This will clear your recorded datasets, are you sure you want to continue?";
...
messages.LEAPHY_SEGMENT_SET_BRIGHTNESS = "Set segment display brightness to %1";
...
messages.LEAPHY_MATRIX_SET_BRIGHTNESS = "Set matrix display brightness to %1";
...
messages.LEAPHY_MESH_CREATE_SIGNAL = "Create signal";
messages.LEAPHY_MESH_NEW_SIGNAL = "Name your signal";
messages.LEAPHY_MESH_ON_SIGNAL = "When I receive %1";
messages.LEAPHY_MESH_BROADCAST_SIGNAL = "Broadcast %1";
messages.LEAPHY_MESH_CALL_SIGNAL = "Send %1 to %2";
messages.LEAPHY_MESH_SENDER = "sender";
...
messages.TEACHABLE_AUDIO_CLASSIFY = "listen and classify sound";
messages.TEACHABLE_AUDIO_DETECTED = "%1 sound detected";
messages.TEACHABLE_AUDIO_CONFIDENCE = "confidence for %1";
messages.TEACHABLE_AUDIO_CATEGORY = "Teachable Machine";
messages.TEACHABLE_AUDIO_OPEN = "Open Teachable Machine";
