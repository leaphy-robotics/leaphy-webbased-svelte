...
const tutorials: Tutorial[] = [
	{
		...
		item: {
			...
			nl: [
				...
				['JqjtGiUV-DM', 'Stap 4 Bouwen Leaphy Starling: Elektronica vastzetten'],
				['CUiXgtLRnP8', 'Stap 5 Bouwen Leaphy Starling: Batterijhouder vastzetten'],
				['PKirp8oF_90', 'Stap 6 Bouwen Leaphy Starling: Computer vastzetten'],
				['HJABnvbLBnY', 'Stap 7 Bouwen Leaphy Starling: Ultrasone sensor vastzetten'],
				['uu5IbabW32E', 'Stap 8 Bouwen Leaphy Starling: Lichtsensoren vastzetten'],
				['nSRSzP814hU', 'Stap 9 Bouwen Leaphy Starling: Lijnvolg sensoren vastzetten'],
				['_NlqZXUzr2o', 'Stap 10 Bouwen Leaphy Starling: RGB lampje vastzetten'],
				['SYbJA4ns4Nk', 'Stap 11 Bouwen Leaphy Starling: Elektronica aansluiten']
			]
		}
	},
	{
		...
		item: [
			{
				...
				video: {
					en: [
						[
							"iEsCwRMnMsQ",
							"1 Leaphy Original: Attaching the motors"
						],
						[
							"_Gx1kIgLb1I",
							"2 Leaphy original: Connecting the wheels"
						],
						[
							"6Q5d7S2GCYs",
							"3 Leaphy original Putting the frame together"
						],
						[
							"2sagwNvQjdo",
							"4 Leaphy original: Attaching the battery holder"
						],
						[
							"B5suiqBWRRg",
							"5 Leaphy original: Connecting the shield"
						],
						[
							"7loksPLC7QQ",
						...
						[
							"X-UvbuvaY20",
							"8 Leaphy original Attaching the line followers"
						],
						[
							"6FPQu1tWPSw",
							"9 Leaphy original Attaching the light sensors"
						],
						[
							"BNiXYCcDOPg",
							"10 Leaphy original Connecting the RGB Led"
						],
						[
							"UO7T408jqek",
							"11 Leaphy original Connecting the nano computer"
						],
						[
							"nD4VvTaSwQM",
						...
						[
							"XkOlXtpx_uc",
							"13 Leaphy original Connecting the tail key"
						]
					],
					nl: [
						[
			...
			},
			{
				...
				video: {
					nl: [
						...
						[
							"-7Zrcv3Kx8E",
							"Level 2 Leaphy original Motorcontrole"
						],
						[
							"3M6XOGd23dA",
							"Level 3 Leaphy original Kleurendobbelsteen"
						],
						[
							"A8fOjkVgmRo",
							"Level 3 Leaphy original Kleurengolf"
						],
						[
							"hIDFF1fDAvU",
							"Level 4 Leaphy original Lijnvolgen"
						],
						[
							"EdPc2vf30E4",
							"Level 5 Leaphy original Lichtsensoren"
						]
					]
				}
			}
